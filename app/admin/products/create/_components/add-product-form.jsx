                    ...
                    <FormControl>
                      <div className="flex flex-wrap gap-2 p-2 border rounded-md">
                        {field.value.map((tag, index) => (
                          <div key={index} className="flex items-center bg-gray-200 dark:text-black rounded-full px-3 py-1">
                            <span>{tag}</span>
                            <Button
                              type="button"
                              variant="ghost"
        ...
        <Card>
          ...
          <CardContent className="">
            <div className="space-y-4  ">
              <div
                {...getRootProps()}
                className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 dark:bg-[#18181B] p-8 text-center cursor-pointer"
              >
                <input {...getInputProps()} />
